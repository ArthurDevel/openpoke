...
function concatFloat32(parts: Float32Array<ArrayBufferLike>[]): Float32Array<ArrayBufferLike> {
...
function floatToInt16(samples: Float32Array<ArrayBufferLike>): Int16Array {
